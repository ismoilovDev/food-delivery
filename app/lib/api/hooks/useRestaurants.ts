...
export const restaurantKeys = {
	...
	list: (params?: RestaurantQueryParams) => [...restaurantKeys.lists(), params] as const,
	detail: (id: number) => [...restaurantKeys.all, id] as const,
	topRated: (limit?: number) => [...restaurantKeys.all, "top-rated", limit] as const,
	featured: (limit?: number) => [...restaurantKeys.all, "featured", limit] as const,
...
export function useActiveRestaurants(params?: { page?: number; limit?: number }) {
	return useQuery({
